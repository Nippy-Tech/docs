...
Flows maneja las landing pages de registro de Nippy. Cada flow es una página pública que captura datos de usuarios y los redirige a una ruleta, curso, URL externa, encuesta o evento.
...
**Respuesta:** `{"_id": "...", "slug": "campana-mayo-2026", "publicUrl": "https://plataforma.nippy.la/flow/campana-mayo-2026", "status": "created", "message": "Flow scaffold created. Additional Console configuration may be needed."}`
...
|-----|--------|-----------|
| `nippy://flows/schema/schemas` | `flows_schemas` | Referencia de campos de la colección `links` (flows) |
| `nippy://flows/schema/glossary` | `flows_glossary` | Términos de negocio y mapeos comunes de consultas |
| `nippy://flows/skill` | `flows_skill` | Instrucciones para el LLM en la vertical de flows |
